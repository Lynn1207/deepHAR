...
def train():
  ...
  with tf.Graph().as_default():
    ...
    logits7=cnnHAR.inference1(local32,'_07')
    logits8=cnnHAR.inference1(local32,'_08')
    logits9=cnnHAR.inference1(local32,'_09')
    logits10=cnnHAR.inference1(local32,'_10')
    logits11=cnnHAR.inference1(local32,'_11')
    logits12=cnnHAR.inference1(local32,'_12')
    logits13=cnnHAR.inference1(local32,'_13')
    logits14=cnnHAR.inference1(local32,'_14')
    logits15=cnnHAR.inference1(local32,'_15')
    logits16=cnnHAR.inference1(local32,'_16')
    logits17=cnnHAR.inference1(local32,'_17')
    logits18=cnnHAR.inference1(local32,'_18')
    logits19=cnnHAR.inference1(local32,'_19')
    logits20=cnnHAR.inference1(local32,'_20')
    logits21=cnnHAR.inference1(local32,'_21')
    logits22=cnnHAR.inference1(local32,'_22')
    logits23=cnnHAR.inference1(local32,'_23')
    logits24=cnnHAR.inference1(local32,'_24')
