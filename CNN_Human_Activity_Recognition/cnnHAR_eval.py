...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    logits3=cnnHAR.inference1(local33,'_03')
    logits4=cnnHAR.inference1(local33,'_04')
    logits5=cnnHAR.inference1(local31,'_05')
    logits6=cnnHAR.inference1(local33,'_06')
    logits7=cnnHAR.inference1(local34,'_07')
    logits8=cnnHAR.inference1(local35,'_08')
    logits9=cnnHAR.inference1(local35,'_09')
    logits10=cnnHAR.inference1(local34,'_10')
    logits11=cnnHAR.inference1(local34,'_11')
    logits12=cnnHAR.inference1(local34,'_12')
