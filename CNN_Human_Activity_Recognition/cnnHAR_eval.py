...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    local25=cnnHAR.inference_local25(reshape1)
    
    logits1=cnnHAR.inference1(local21,'_01')
    logits2=cnnHAR.inference1(local22,'_02')
    logits3=cnnHAR.inference1(local22,'_03')
    logits4=cnnHAR.inference1(local23,'_04')
    logits5=cnnHAR.inference1(local22,'_05')
    logits6=cnnHAR.inference1(local22,'_06')
    logits7=cnnHAR.inference1(local24,'_07')
    logits8=cnnHAR.inference1(local24,'_08')
    logits9=cnnHAR.inference1(local24,'_09')
    logits10=cnnHAR.inference1(local24,'_10')
    logits11=cnnHAR.inference1(local24,'_11')
    logits12=cnnHAR.inference1(local24,'_12')
    logits13=cnnHAR.inference1(local24,'_13')
    logits14=cnnHAR.inference1(local24,'_14')
    logits15=cnnHAR.inference1(local24,'_15')
    logits16=cnnHAR.inference1(local24,'_16')
    logits17=cnnHAR.inference1(local24,'_17')
    logits18=cnnHAR.inference1(local24,'_18')
    logits19=cnnHAR.inference1(local24,'_19')
    logits20=cnnHAR.inference1(local25,'_20')
    logits21=cnnHAR.inference1(local24,'_21')
    logits22=cnnHAR.inference1(local24,'_22')
    logits23=cnnHAR.inference1(local24,'_23')
    logits24=cnnHAR.inference1(local24,'_24')
