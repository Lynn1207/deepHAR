...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    logits13=cnnHAR.inference1(reshape1,'_13')
    logits14=cnnHAR.inference1(reshape1,'_14')
    logits15=cnnHAR.inference1(reshape1,'_15')
    logits16=cnnHAR.inference1(reshape1,'_16')
    logits17=cnnHAR.inference1(reshape1,'_17')
    logits18=cnnHAR.inference1(reshape1,'_18')
    logits19=cnnHAR.inference1(reshape1,'_19')
    logits20=cnnHAR.inference1(reshape1,'_20')
    logits21=cnnHAR.inference1(reshape1,'_21')
    logits22=cnnHAR.inference1(reshape1,'_22')
    logits23=cnnHAR.inference1(reshape1,'_23')
    logits24=cnnHAR.inference1(reshape1,'_24')
