...
def inference_cov11(signals):
    with tf.variable_scope('conv1_1_3_4_5_6') as scope:
         ...
         # pool1
    pool1 = tf.nn.max_pool1d(conv1, ksize=[1,3,1], strides=[1,3,1],padding='VALID',name='pool1_1_3_4_5_6')
...
def inference_cov12(signals):
    with tf.variable_scope('conv1_2') as scope:
         ...
         # pool1
    pool1 = tf.nn.max_pool1d(conv1, ksize=[1,3,1], strides=[1,3,1],padding='VALID',name='pool1_2')
