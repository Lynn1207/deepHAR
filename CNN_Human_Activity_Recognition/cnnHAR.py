...
def inference_cov11(signals):
    with tf.variable_scope('conv1_1_2_3_4_5_6') as scope:
         ...
         # pool1
    pool1 = tf.nn.max_pool1d(conv1, ksize=[1,3,1], strides=[1,3,1],padding='VALID',name='pool1_1_2_3_4_5_6')
...
def inference_cov12(signals):
    with tf.variable_scope('conv1_5') as scope:
         ...
         # pool1
    pool1 = tf.nn.max_pool1d(conv1, ksize=[1,3,1], strides=[1,3,1],padding='VALID',name='pool1_5')
...
def inference_local21(reshape):
    ...
    with tf.variable_scope('local2_1_2_3_4_5_6') as scope:
...
def inference_local31(local2):
    with tf.variable_scope('local3_1_2_3_4_5_6') as scope:
        # Move everything into depth so we can perform a single matrix multiply.
