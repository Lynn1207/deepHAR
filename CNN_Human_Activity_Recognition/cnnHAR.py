...
def inference_cov11(signals):
    with tf.variable_scope('conv1_01_03_04_05_06') as scope:
         ...
         # pool1
    pool1 = tf.nn.max_pool1d(conv1, ksize=[1,3,1], strides=[1,3,1],padding='VALID',name='pool1_01_03_04_05_06')
...
def inference_local21(reshape):
    ...
    with tf.variable_scope('local2_01_03_04_06') as scope:
...
def inference_local31(local2):
    with tf.variable_scope('local3_01_03_04_06') as scope:
        # Move everything into depth so we can perform a single matrix multiply.
...
def inference_local41(local3):
    with tf.variable_scope('local4_01_03_04_06') as scope:
